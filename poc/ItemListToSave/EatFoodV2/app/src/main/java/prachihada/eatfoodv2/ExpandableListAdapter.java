...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter(Context context, List<String> listDataHeader,
                                 HashMap<String, List<String>> listChildData, HashMap<String,Integer> finalList) {
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus) {
                    ...
                    finalList.put(childText,Integer.parseInt(quantity));
    ...
    public HashMap<String, Integer> getFinalList() {
        return finalList;
    }

    public void setFinalList(HashMap<String, Integer> finalList) {
        this.finalList = finalList;
    }
}